  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      const responseAPI = await fetch(
        `${currentServerDomain}/api/parent/home`,
        {
          method: "GET",
        }
      );
      ...
      if (responseAPI.status === 200) {
        ...
        getDownloadURL(
          ref(storage, `photos/${responseBody.studentDetails.studentUSN}.jpg`)
        )
          .then((url) => {
            setPhotoUrl(url);
  ...
  return (
    <div className={styles.homePageContainer}>
        ...
        {dataFetched ? (
          <div>
            <div className={styles.studentName}>
              Welcome, Parent of {studentDetails?.studentName}
            </div>
            <div className={styles.studentDetail}>
              USN: {studentDetails?.studentUSN}, CLASS:{" "}
      ...
      <div className={styles.menuBox}>
        <Link href="/parent/attendance" shallow={true}>
        ...
        <Link href="/parent/grades" shallow={true}>
          <div className={styles.menuItem}>
            <div className={styles.menuItemIcon}>
              <RxReader
                size={25}
        ...
        <Link
          href={{ pathname: "/parent/grades", query: { tab: 1 } }}
          shallow={true}
        >
          <div className={styles.menuItem}>
            <div className={styles.menuItemIcon}>
