    ...
    async function fetchAttendanceData() {
      try {
        ...
        const responseAPI = await fetch(
          `${currentServerDomain}/api/student/attendance`,
          {
            method: "GET",
          }
        );
        ...
        <table className={styles.attendanceTable}>
          <thead>
            <tr>
              ...
              <th className={styles.tableHead}>Faculty</th>
              <th
                className={styles.tableHead}
          ...
          <tbody>
            {subjectOptions && dataFetched ? (
              subjectOptions.map((theorySubject, filteredIndex) => {
                // Find the original index in the unfiltered arra
                ...
                return (
                  <tr key={filteredIndex}>
                    ...
                    <td className={styles.tableData}>
                      {theorySubject.faculties
                        ? theorySubject.faculties?.join(", ")
                        : ""}
                    </td>
